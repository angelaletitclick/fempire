 ...
 * Auf Pink und Pink-Deep steht immer weiße Schrift (AA-konform), nie Plum.
 */
...
const variants: Record<Variant, string> = {
  primary: "bg-white text-plum hover:bg-pink hover:text-white",
  accent: "bg-pink text-white hover:bg-pink-deep",
  outline: "border border-white/40 text-white hover:border-pink hover:bg-pink",
};
